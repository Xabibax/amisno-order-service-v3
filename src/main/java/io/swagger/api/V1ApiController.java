...
public class V1ApiController implements V1Api {
    ...
    public ResponseEntity<Order> createOrder(@Parameter(in = ParameterIn.DEFAULT, description = "create an order", required=true, schema=@Schema()) @Valid @RequestBody Order body) {
    ...
    public ResponseEntity<Order> getOrderById(@Parameter(in = ParameterIn.PATH, description = "ID of the order that needs to be fetched", required=true, schema=@Schema()) @PathVariable("orderId") String orderId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Order>(objectMapper.readValue("{\n  \"id\" : \"id\",\n  \"complete\" : false,\n  \"shipDate\" : \"2000-01-23T04:56:07.000+00:00\",\n  \"articles\" : [ \"articles\", \"articles\" ],\n  \"userId\" : \"userId\",\n  \"status\" : \"placed\"\n}", Order.class), HttpStatus.NOT_IMPLEMENTED);
